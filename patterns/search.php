...
<main class="wp-block-group has-background" style="background-color:#f7f5f3;padding-right:2.25rem;padding-left:2.25rem"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
